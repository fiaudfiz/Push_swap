...
/*   Updated: 2026/02/23 11:13:50 by miouali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_stack	*loop_target(t_stack *stack_b, t_stack *temp_a)
{
	int		j;
	t_stack	*temp_b;
...
void	set_target_a_to_b(t_stack *stack_a, t_stack *stack_b)
{
	...
	{
		temp_a->target_node = loop_target(stack_b, temp_a);
		i++;
		temp_a = temp_a->next;
	}
}
